...
module.exports = {
    async signIn(req, res) {
        try {
            ...
            if (!isuser) return res.status(404).json({ message: 'user not found please create new account', link: 'http://localhost:5000/register' });
            ...
            if (isValiduser) {
                ...
                res.status(404).json({ message: "password or email doesn't match" })
            }
